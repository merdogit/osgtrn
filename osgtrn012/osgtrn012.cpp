...
{
public:
    ImGuiPlaneHandler(PlaneMotion *motion, osgViewer::Viewer *viewer)
        : _motion(motion), _viewer(viewer), _currentView(CameraView::Chase)
    {
...
int main()
{
    ...
    viewer.addEventHandler(new ImGuiPlaneHandler(&motion, &viewer));
