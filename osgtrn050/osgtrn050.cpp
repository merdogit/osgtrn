// ========== Include GLEW before OSG ==========
// Make sure this is at the very top of the .cpp
#define IMGUI_IMPL_OPENGL_LOADER_GLEW
#include <GL/glew.h>

// ========== Now include OSG & ImGui ==========
#include <osg/Camera>
    ...
    bool handle(const osgGA::GUIEventAdapter& ea, osgGA::GUIActionAdapter& aa) override
    {
        ...
        if (_target.valid() && ea.getEventType() == osgGA::GUIEventAdapter::FRAME)
        {
            ...
            if (!paths.empty())
            {
                ...
                std::cout << "in FollowOrbitManipulator\n";
            }
        }
        return handled;
    }
...
public:
    ...
    void drawUi() override
    {
        ...
        ImGui::Text("Active Camera: %s", modes[_selected]);
        ImGui::End();
    }
...
int main(int argc, char** argv)
{
    ...
    osg::Vec3d eye0(0.0, -60.0, 25.0), center0(0, 0, 0), up0(0, 0, 1);
...
// ---- Manual cleanup (since OSG 3.7 lacks setDoneOperation) ----
